...
interface ProfileInfoFormProps {
  initial: { name: string; username: string; phone: string; bio: string };
}

export function ProfileInfoForm({ initial }: ProfileInfoFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea id="bio" name="bio" defaultValue={initial.bio} maxLength={160} rows={3} className={inputClass} />
      </div>
